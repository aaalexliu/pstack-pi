...
2. Name the feature's core data shape and owner. Read `../../principle-model-the-domain/SKILL.md` and `../../principle-boundary-discipline/SKILL.md`.
...
6. Verify the real surface, then run the full repository check.
7. Commit in small units when each unit can pass on its own.
