...
4. Use one `subagent` call with `tasks` for independent work. Keep at most eight tasks and expect at most four active children.
...
7. Review and integrate each result in input order. Run one full check after integration.
