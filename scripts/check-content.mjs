...
export function extensionFiles(inventory) {
  return inventory.byDestination.has('agents/general-purpose.md')
    ? ['extensions/subagent/agents.ts', 'extensions/subagent/domain.ts', 'extensions/subagent/index.ts', 'extensions/subagent/model-config.ts', 'extensions/subagent/model-runtime.ts', 'extensions/subagent/process.ts', 'extensions/subagent/runner.ts', 'extensions/subagent/scheduler.ts'] : [];
}
